...
<div class="nav-wrapper">
    <div class="topnav">
        <div class="nav-left">
            ...
            <div class="nav-links">
                <a href="${pageContext.request.contextPath}/loanofficer" class="nav-link">Single Loan</a>
                <a href="${pageContext.request.contextPath}/bulk" class="nav-link">Bulk Scoring</a>
